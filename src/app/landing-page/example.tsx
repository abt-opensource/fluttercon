  ...
  return (
    <div className="mx-auto mb-20 w-[95%] xl:w-[75%]">
      <div className="mb-10 flex w-full flex-col">
        <h1 className="mb-5 w-full font-extrabold text-2xl md:w-[50%] md:text-4xl">Making beautiful designs
          with Flutercon is easy</h1>
        <p className="w-full text-slate-300 text-xs sm:text-sm md:w-[50%]">Whether you're working with SaaS platforms, websites, or any modern interfaces, Flutercon brings a magical touch to your designs. Discover a selection below...</p>
      </div>
